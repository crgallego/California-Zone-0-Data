...
| `year_built_by_fhsz_county.csv`, `year_built_by_fhsz_state.json` | US Census Bureau (PL 94-171, ACS 2020-2024) + same FHSZ layers | Census: public domain. FHSZ: CC BY | PL 94-171 CA redistricting file; ACS 5-year table B25034 | 2020 census; ACS 2020-2024; retrieved 2026-08-14 | Same basis as above; Firewise's decade-share modeling is the Firewise contribution. The 2000-2009 bucket is published unsplit because it straddles the 2008 Chapter 7A boundary |
| `year_built_dins.json` | CAL FIRE Damage Inspection (DINS) | Public, CA state, Creative Commons Attribution | Open ArcGIS feature service (`POSTFIRE_MASTER_DATA_SHARE`), fields `YEARBUILT` and `FENCEATTACHEDTOSTRUCTURE` | recorded since 2013; queried 2026-08-14 | CC BY attribution obligation satisfied by naming CAL FIRE DINS and the dataset landing page; Firewise's survival filter and year/fence cross-tab are the Firewise contribution |
...
| `compliance_forcing_functions.json` | California Department of Insurance, California Legislative Counsel, and official California regulations | Official public legal/regulatory text; citation-only file with no private data | 10 CCR 2644.9; Civil Code §§ 1102.19 and 841; links are carried in the JSON | effective dates recorded in file; compiled 2026-08-14 | Verbatim short quotations are attributed to the official authorities and paired with subdivisions/links. The file intentionally omits California FAIR Plan Association material because its redistribution terms were not cleared |
| `fire_risk_reduction_communities_2026.csv` | California Board of Forestry and Fire Protection | Official state public-agency list; aggregate agency names/types only | 2026 Fire Risk Reduction Community List and Resolution No. 2026-01, official Board download linked in `scripts/build_frrc_list.py` | effective 2026-07-01 through 2028-06-30 | Normalized from the Board's official PDF, with source attribution and no private-person or property-level fields. The Board page states the list is mandated by PRC 4290.1 and maintained/updated every two years |
